...
| [ifIs](if-is.md) | `fun <T> `[`T`](if-is.md#T)`.ifIs(valueToCompare: `[`T`](if-is.md#T)`?, block: `[`T`](if-is.md#T)`.() -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)<br>ifIs provides a block to match the value with Given Value and execute the block |
| [ifIsNot](if-is-not.md) | `fun <T> `[`T`](if-is-not.md#T)`.ifIsNot(valueToCompare: `[`T`](if-is-not.md#T)`?, block: (`[`T`](if-is-not.md#T)`) -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)<br>ifIs provides a block to match the value with Given Value and execute the block |
...
| [runOnUIThread](run-on-u-i-thread.md) | `fun runOnUIThread(runnable: () -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`): `[`Boolean`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)<br>Run the UI Code on UI Thread From AnyWhere, No need the Activity Reference |
